 ...
 * </ul>
 */
public class DatafogHotspotBenchmark extends Workload {
  /**
  ...
  public static final String HOTSPOT_GEOHASH_PROPERTY = "hotspot_geohash";
  public static final String HOTSPOT_GEOHASH_DEFAULT = "";

  public static final String AREA_GEOHASH_PROPERTY = "area_geohash";
  public static final String AREA_GEOHASH_DEFAULT = "";
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    hotspotGeohash = p.getProperty(HOTSPOT_GEOHASH_PROPERTY, HOTSPOT_GEOHASH_DEFAULT);
    areaGeohash = p.getProperty(AREA_GEOHASH_PROPERTY, AREA_GEOHASH_DEFAULT);
    if (areaGeohash.equals("") || hotspotGeohash.equals("") || (!hotspotGeohash.startsWith(areaGeohash))) {
      System.err.println("AreaGeohash and HotspotGeohash are incompatible");
      System.exit(-1);
    }
