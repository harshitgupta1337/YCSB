 ...
 * <LI><b>locationdistribution</b>: what distribution should location of events be selected from 
 * on - uniform, hotspot or latest (default: uniform)
...
public class FogstoreBenchmark extends Workload {
   ...
   */
  public static final String PARTITION_KEY_COLUMN_NAME = "part_key";
  ...
  public static final String PARTITION_KEY_TYPE_PROPERTY = "partition_key_type";
  public static final String PARTITION_KEY_TYPE_PROPERTY_DEFAULT = "hybrid";
  ...
  /**
   * The name of the property for the the distribution of locations across the Lat-Lng space. Options are
   * "uniform", "hotspot"
   */
  public static final String LOCATION_DISTRIBUTION_PROPERTY = "locationdistribution";

  /**
   * The default distribution of locations of requests across the Lat-Lng space.
   */
  public static final String LOCATION_DISTRIBUTION_PROPERTY_DEFAULT = "uniform";

  /**
   * The name of property storing the minimum latitude value
   */
  public static final String MIN_LATITUDE_PROPERTY = "minlatitude";

  /**
   * The default minimum latitude
   */
  public static final String MIN_LATITUDE_PROPERTY_DEFAULT = "0.0";

  /**
   * The name of property storing the minimum latitude value
   */
  public static final String MIN_LONGITUDE_PROPERTY = "minlongitude";

  /**
   * The default minimum longitude
   */
  public static final String MIN_LONGITUDE_PROPERTY_DEFAULT = "0.0";

  /**
   * The name of property storing the minimum latitude value
   */
  public static final String MAX_LATITUDE_PROPERTY = "maxlatitude";

  /**
   * The default maximum latitude
   */
  public static final String MAX_LATITUDE_PROPERTY_DEFAULT = "10.0";

  /**
   * The name of property storing the minimum latitude value
   */
  public static final String MAX_LONGITUDE_PROPERTY = "maxlongitude";

  /**
   * The default maximum longitude
   */
  public static final String MAX_LONGITUDE_PROPERTY_DEFAULT = "10.0";
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    String locationdistrib =
        p.getProperty(LOCATION_DISTRIBUTION_PROPERTY, LOCATION_DISTRIBUTION_PROPERTY_DEFAULT);
...
*/
    ...
    partitionKeyType = p.getProperty (PARTITION_KEY_TYPE_PROPERTY, PARTITION_KEY_TYPE_PROPERTY_DEFAULT);
  }
